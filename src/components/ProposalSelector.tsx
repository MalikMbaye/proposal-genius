  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="outline" 
          className="h-10 px-6 gap-4 bg-slate-100 hover:bg-white border-slate-300 text-slate-800 w-full max-w-xl justify-between shadow-sm"
        >
          <div className="flex items-center gap-3">
            <div className="h-7 w-7 rounded-md bg-primary/15 flex items-center justify-center">
              <FileText className="h-4 w-4 text-primary" />
            </div>
            <span className="text-xs text-slate-500 uppercase tracking-wide">Current Proposal:</span>
            <span className="font-semibold text-sm truncate max-w-[250px] text-slate-900">{displayName}</span>
          </div>
