    ...
    <>
      ...
      <div className="px-3 pb-2 border-t border-slate-700 pt-3">
        <Link
          to="/library"
          onClick={onNavigate}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all text-emerald-400 hover:text-emerald-300 border border-emerald-500/50 hover:border-emerald-400 hover:bg-emerald-500/10"
        >
